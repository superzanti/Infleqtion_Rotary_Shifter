...
#
# Infleqtion_rot_shifter.tcl: Tcl script for re-creating project 'Infleqtion_rot_shifter'
#
# Generated by Vivado on Tue Oct 07 19:52:55 -0600 2025
...
#
# 1. This project restoration tcl script (Infleqtion_rot_shifter.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Admin/Downloads/Infleqtion/target/Infleqtion_rot_shifter/Infleqtion_rot_shifter.srcs/utils_1/imports/synth_1/fpga_top.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/Users/Admin/Downloads/Infleqtion/src/rot_shifter.vhd"
#    "C:/Users/Admin/Downloads/Infleqtion/src/rot_shifter_axi.vhd"
#    "C:/Users/Admin/Downloads/Infleqtion/constraints/rot_shifter_axi.xdc"
#    "C:/Users/Admin/Downloads/Infleqtion/src/rot_shifter.vhd"
#    "C:/Users/Admin/Downloads/Infleqtion/src/rot_shifter_axi.vhd"
#    "C:/Users/Admin/Downloads/Infleqtion/sim/rot_shifter_axi_tb.sv"
#    "C:/Users/Admin/Downloads/Infleqtion/sim/rot_shifter_axi_tb_behav.wcfg"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../target/Infleqtion_rot_shifter/Infleqtion_rot_shifter.srcs/utils_1/imports/synth_1/fpga_top.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../src/rot_shifter.vhd"]"\
 "[file normalize "$origin_dir/../src/rot_shifter_axi.vhd"]"\
 "[file normalize "$origin_dir/../constraints/rot_shifter_axi.xdc"]"\
 "[file normalize "$origin_dir/../src/rot_shifter.vhd"]"\
 "[file normalize "$origin_dir/../src/rot_shifter_axi.vhd"]"\
 "[file normalize "$origin_dir/../sim/rot_shifter_axi_tb.sv"]"\
 "[file normalize "$origin_dir/../sim/rot_shifter_axi_tb_behav.wcfg"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "Infleqtion_rot_shifter"
...
set script_file "Infleqtion_rot_shifter.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../target/Infleqtion_rot_shifter"]"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7s15cpga196-2

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Reconstruct message rules
set_msg_config  -id {Synth 8-7129}  -string {{WARNING: [Synth 8-7129] Port shift_amt[7] in module rot_shifter is either unconnected or has no load}}  -suppress  -ruleid {1}  -source 8
set_msg_config  -id {Synth 8-7129}  -string {{WARNING: [Synth 8-7129] Port shift_amt[6] in module rot_shifter is either unconnected or has no load}}  -suppress  -ruleid {2}  -source 8
set_msg_config  -severity {STATUS}  -suppress  -ruleid {6}  -source 2
set_msg_config  -severity {INFO}  -suppress  -ruleid {7}  -source 2
set_msg_config  -severity {WARNING}  -suppress  -ruleid {8}  -source 2
...
set file "$origin_dir/../src/rot_shifter.vhd"
...
set file "$origin_dir/../src/rot_shifter_axi.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL 2008" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "rot_shifter_axi" -objects $obj
...
set file "[file normalize "$origin_dir/../constraints/rot_shifter_axi.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../constraints/rot_shifter_axi.xdc"
set file [file normalize $file]
...
set file "$origin_dir/../sim/rot_shifter_axi_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
...
set file "$origin_dir/../sim/rot_shifter_axi_tb_behav.wcfg"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "rot_shifter_axi_tb" -objects $obj
...
set_property -name "xsim.simulate.runtime" -value "2500ns" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7s15cpga196-2 -flow {Vivado Synthesis 2024} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/fpga_top.dcp" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7s15cpga196-2 -flow {Vivado Implementation 2024} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
